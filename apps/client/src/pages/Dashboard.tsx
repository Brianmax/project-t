...
const cards = [
  {
    ...
    containerCls:
      'bg-blue-50 dark:bg-blue-950/40 ring-blue-100 dark:ring-blue-800/40',
  ...
  },
  {
    ...
    containerCls:
      'bg-violet-50 dark:bg-violet-950/40 ring-violet-100 dark:ring-violet-800/40',
  ...
  },
  {
    ...
    containerCls:
      'bg-emerald-50 dark:bg-emerald-950/40 ring-emerald-100 dark:ring-emerald-800/40',
  ...
  },
  {
    ...
    containerCls:
      'bg-amber-50 dark:bg-amber-950/40 ring-amber-100 dark:ring-amber-800/40',
  ...
  },
  {
    ...
    containerCls:
      'bg-rose-50 dark:bg-rose-950/40 ring-rose-100 dark:ring-rose-800/40',
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-4">
        {cards.map((card, i) => (
          <Link
            key={card.key}
            to={card.to}
            className="group relative bg-surface rounded-2xl border border-border p-5 hover:shadow-lg hover:shadow-shadow hover:border-border transition-all duration-200 hover:-translate-y-0.5 opacity-0 animate-fade-in"
            style={{ animationDelay: `${i * 60}ms` }}
          >
            <div className="flex items-center justify-between mb-4">
              <div
                className={`w-10 h-10 rounded-xl ${card.containerCls} ring-1 flex items-center justify-center`}
              >
